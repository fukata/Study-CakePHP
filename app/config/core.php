 ...
 */
	Configure::write('Security.salt', 'fbc5ddef0801c61baa77a6f73f6d7875049819da');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '174862551995671078821717636344821627776320940');
